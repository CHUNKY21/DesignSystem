...
## References
- **Design System:** See /docs/design-system.md — follow these visual specifications for all UI work. Do not hardcode colors, font sizes, spacing, or shadows. Use Tailwind tokens that reference these design system values.
